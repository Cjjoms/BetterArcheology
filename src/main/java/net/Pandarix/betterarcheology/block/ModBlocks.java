...
public class ModBlocks
{
    ...
    //-------------FOSSILS---------------//
    //Villager
    public static final Block VILLAGER_FOSSIL = registerBlockWithRarity("villager_fossil", new VillagerFossilBlock(AbstractBlock.Settings.copy(Blocks.BONE_BLOCK).luminance((state) -> state.get(VillagerFossilBlock.INVENTORY_LUMINANCE))), ModItemGroup.BETTER_ARCHEOLOGY_ITEMGROUP, Rarity.UNCOMMON);
